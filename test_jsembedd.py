...
df = pd.read_csv('datasets/top-1m.csv', nrows= NUM_ROWS)
...
for i in range(NUM_BROWSERS):
    ...
    browser_params[i]['js_instrument_settings'] = ['Performance'] # Data is saved to the javascript table
...
command_sequence = CommandSequence.CommandSequence('js_embedding.html', reset=True)
